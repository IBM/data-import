...
def main():
	...
	generic_table_fields='[{"key_name":"Provider","element_type":"ALN"},{"key_name":"Confidence","element_type":"NUM"},{"key_name":"First Seen Date","element_type":"DATE"},{"key_name":"Last Seen Date","element_type":"DATE"}]'
	malware_table_fields='[{"key_name":"Provider","element_type":"ALN"},{"key_name":"Confidence","element_type":"NUM"},{"key_name":"First Seen Date","element_type":"DATE"},{"key_name":"Last Seen Date","element_type":"DATE"},{"key_name":"Malware Family","element_type":"ALNIC"}]'
	botnet_table_fields='[{"key_name":"Provider","element_type":"ALN"},{"key_name":"Confidence","element_type":"NUM"},{"key_name":"First Seen Date","element_type":"DATE"},{"key_name":"Last Seen Date","element_type":"DATE"},{"key_name":"Botnet Name","element_type":"ALNIC"}]'
	anon_table_fields='[{"key_name":"Provider","element_type":"ALN"},{"key_name":"Confidence","element_type":"NUM"},{"key_name":"First Seen Date","element_type":"DATE"},{"key_name":"Last Seen Date","element_type":"DATE"},{"key_name":"Anonymizer Name","element_type":"ALNIC"}]'
